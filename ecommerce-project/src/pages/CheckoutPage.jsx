        ...
        <div className="checkout-grid">
          ...
          <div className="payment-summary">
            ...
            <div className="payment-summary-row">
              ...
              <div className="payment-summary-money">{formatMoney(paymentSummary.shippingHandling)}</div>
            </div>

            <div className="payment-summary-row subtotal-row">
              <div>Total before tax:</div>
              <div className="payment-summary-money">{formatMoney(paymentSummary.totalConstsBeforeTaxCents)}</div>
            </div>
